...
const AdminDashboard = () => {
  const state = {
    series: [
      {
        name: "Orders",
        data: [22, 33, 443, 334, 54, 33],
      },
      {
        name: "Revenue",
        data: [22, 33, 443, 334, 54],
      },
      {
        name: "Sellers",
        data: [22, 33, 443, 334, 54],
    ...
    <div className="px-2 md:px-7 py-5">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
        <div className="flex justify-between items-center p-5 bg-[#fae8e8] rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-[rgb(92,90,90)]">
            <h2 className="text-3xl font-bold">$3444</h2>
        ...
        <div className="flex justify-between items-center p-5 bg-[#ecebff] rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-[#5c5a5a]">
            <h2 className="text-3xl font-bold">453</h2>
      ...
      <div className="w-full flex flex-wrap mt-7">
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="bg-[#6a5fdf] w-full p-4 rounded-md text-[#d0d2d6]">
            <div className="flex justify-between items-center">
              <h2 className="text-[#d0d2d6] font-semibold text-lg pb-3">
                ...
                <li className="mb-3 ml-6">
                  ...
                  <div className="p-3 bg-slate-800 rounded-lg border border-slate-600 shadow-sm">
                    <div className="flex justify-between items-center mb-2 ">
                      ...
                      <time className="mb-1 text-sm font-normal sm:mb-0 sm:order-last">
                        2 day ago
                      </time>
                    </div>
      ...
      <div className="w-full p-4 bg-[#6a5fdf] rounded-md mt-6">
        ...
        <div className="relative overflow-x-auto">
          <table className="w-full text-sm text-left text-[#d0d2d6]">
            <thead className="text-sm border-b border-slate-700  text-[#d0d2d6]">
              <tr>
