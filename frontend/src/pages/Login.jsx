...
const Login = () => {
  ...
  }, [successMessage, errorMessage, dispatch, userInfo, navigate]);
        ...
        <div className="w-full justify-center items-center p-10">
          <div className="grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md">
            <div className="px-8 py-8">
              ...
              <a
                target="_blank"
                href="https://mutivendor-ecommerce-mern-dashboard.vercel.app/login"
              >
              ...
              <a
                target="_blank"
                href="https://mutivendor-ecommerce-mern-dashboard.vercel.app/register"
              >
