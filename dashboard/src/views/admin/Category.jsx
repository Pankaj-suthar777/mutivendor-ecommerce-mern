                    ...
                    <tr key={i}>
                      ...
                      >
                        <div className="flex justify-start items-center gap-4">
                          <Link className="p-[6px] bg-yellow-500 hover:shadow-lg hover:shadow-yellow-500/50 rounded">
                            <FaEdit />
                          </Link>
                          <Link className="p-[6px] bg-red-500 hover:shadow-lg hover:shadow-red-500/50 rounded">
                            <FaTrash />
                          </Link>
                        </div>
                      </td>
